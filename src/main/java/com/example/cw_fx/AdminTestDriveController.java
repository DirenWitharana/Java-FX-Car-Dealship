...
public class AdminTestDriveController implements Initializable {
    @FXML
    ...
    public void addAppointment(ActionEvent actionEvent){
        ...
        CustomerDetails customer = new CustomerDetails(customer1.getCustomerName(), customer1.getAddress(), customer1.getPhoneNo(),
                ...
                customer1.getSellPrice(), customer1.getAvailability(), d);
        if (customer1 == null) {
            ...
            if (customerName!="" && address!="" && phoneNo!="") {
                try {
                    Writer details = new FileWriter("test_drive.txt", false);
